...
export class Game {
    ...
    addOrUpdatePlayer(chatter) {
        ...
        player.addEnergy();
        console.log(`Player ${chatter.username} gained energy. Current energy cells: ${player.energyTimestamps.length}, Current Position: (${player.pixelX.toFixed(2)}, ${player.pixelY.toFixed(2)})`);
    }
